...
namespace AST
{
    ...
    public class If_Else : Expr
    {
        ...
        public override string ToString()
        {
            return "If: " + cond.ToString() + " Then: " + then.ToString() + ((elsse != null)? (" Else: " + elsse.ToString()) : "");
        }
    }
    ...
    public class Branch : Node
    {
        ...
        public Expr exp;
        public Branch(Formal formal, Expr exp) : base(new Node[] { formal, exp })
        {
            this.formal = formal;
            this.exp = exp;
        }
    ...
    public class CASE_OF : Expr
    {
        public Expr exp;
        public Lista<Branch> branches;

        public CASE_OF(Expr exp, Lista<Branch> branches) : base(new Node[] { exp, branches })
        {
            this.exp = exp;
